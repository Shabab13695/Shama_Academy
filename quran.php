			...
			<div class="container shadow-container">
				<div class="row">
					...
					<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
							...
							<img src="images/image/12.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/image/16.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/image/13.jpg" class="img-thumbnail img-thumbnale">
					</div>
				...
				<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
							...
							<img src="images/image/7.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/image/8.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/image/9.jpg" class="img-thumbnail img-thumbnale">
					</div>
				</div>
</div>

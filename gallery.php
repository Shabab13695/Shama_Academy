			...
			<div class="container shadow-container staff">
				<div class="row">
					...
					<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
							...
							<img src="images/our school/1.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/2.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/3.jpg" class="img-thumbnail img-thumbnale">
					</div>
				...
				<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
							...
							<img src="images/our school/24.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/5.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/6.jpg" class="img-thumbnail img-thumbnale">
					</div>
				<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
						
							<img src="images/our school/19.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/20.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/21.jpg" class="img-thumbnail img-thumbnale">
					</div>	
				</div>
</div>
<div class="container ">
	<div class="group">
		...
		<a href="next.php" button type="submit" class="btn btn-warning col-lg-offset-4">More Images</a>
	</div>
</div>	
</section>
<?php

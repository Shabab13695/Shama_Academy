			...
			<div class="container shadow-container">
				<div class="row">
					...
					<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
							...
							<img src="images/our school/7.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/8.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/9.jpg" class="img-thumbnail img-thumbnale">
					</div>
				...
				<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
							...
							<img src="images/our school/10.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/11.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/12.jpg" class="img-thumbnail img-thumbnale">
					</div>
				<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
						
							<img src="images/our school/13.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/14.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/15.jpg" class="img-thumbnail img-thumbnale">
					</div>
				...
				<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
							...
							<img src="images/our school/16.jpg" class="img-thumbnail img-thumbnale">
			
					</div>

					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/17.jpg" class="img-thumbnail img-thumbnale">
				
			
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						
							<img src="images/our school/18.jpg" class="img-thumbnail img-thumbnale">
					</div>	
				</div>
</div>
<div class="container">
	<div class="group">
		...
		<a href="gallery.php" button type="submit" class="btn btn-warning col-lg-offset-4">Prev</a>
	</div>
</div>	
